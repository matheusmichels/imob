        ...
        DefaultTable<Rent>
{
    public RentTable()
    {
        ...
        (
                        ...
                        protected void updateItem( Integer item, boolean empty )
                        {
                            ...
                            if( ! empty )
                            {
                                try
                                {
                                    ...
                                    List<Payment> payments = fm.getRemainingPayments( item, false );
            ...
            new DefaultTable.Column( "Proprietário", "ownerId", 300d, new Callback< TableColumn<Immobile, Integer>, TableCell<Immobile, Integer> >()
            {
                @Override
                public TableCell<Immobile, Integer> call( TableColumn<Immobile, Integer> param )
                {
            ...
            new DefaultTable.Column( "Locatário", "renterId", 300d, new Callback< TableColumn<Immobile, Integer>, TableCell<Immobile, Integer> >()
            {
                @Override
                public TableCell<Immobile, Integer> call( TableColumn<Immobile, Integer> param )
                {
            ...
            new DefaultTable.Column( "Valor Aluguel", "value", 150d, new Callback< TableColumn<Immobile, Double>, TableCell<Immobile, Double> >()
            {
                @Override
            ...
            new DefaultTable.Column( "Tempo de Contrato", "months", 150d, new Callback< TableColumn<Immobile, Integer>, TableCell<Immobile, Integer> >()
            {
                @Override
                public TableCell<Immobile, Integer> call( TableColumn<Immobile, Integer> param )
                {
            ...
            new DefaultTable.Column( "Data Contrato", "date", 150d, new Callback< TableColumn<Immobile, Date>, TableCell<Immobile, Date> >()
            {
                @Override
