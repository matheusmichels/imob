...
import view.com.imob.view.tables.RentTable;
        ...
        DefaultPane
{
    ...
    public void refreshContent()
    {
        try
        {
            ...
            else
            {
                if ( selected != null )
                {
                    List<Payment> payments = fm.getPayments( selected.getId(), false );
    ...
    private void enter()
    {
        try
        {
            selected = rentTable.getSelectedItem();
        ...
        if ( selected != null )
        {
            if ( selected.getDate() == null )
            {
                try
                {
                    ...
                    int minimum = fm.getMinimumPlot( this.selected.getId(), false );
    ...
    public void initComponents()
    {
        ...
        rentTable.addEventHandler( DefaultTable.ON_DOUBLE_CLICK, new EventHandler<Event>()
        {
            @Override
    ...
    private RentTable rentTable = new RentTable();
    ...
    private ActionCategory saleActions = new ActionCategory( "Aluguéis", new Action[]
    {
       pay 
    });
}